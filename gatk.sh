...
do
    ...
    ## GatherVcfs works only if file ends with .vcf (Doh!) and also if interval
    ## padding has NOT been applied
    ## Gather gVCFs
    #$GATK_PATH/gatk GatherVcfs \
    #    --INPUT $BAM_PATH/$SAMPLE/interval_gvcfs.txt \
...
# The normalization step is potentially not required but run nervertheless
$BCFTOOLS_PATH/bcftools view \
